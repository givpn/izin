...
REPO1="https://raw.githubusercontent.com/givpn/izin/master/"
...
function download_config(){
    ...
    wget -q -O /etc/banner "${REPO1}config/banner" >/dev/null 2>&1
    
    # > Add menu, thanks to unknow
    wget -O /tmp/menu-master.zip "${REPO1}config/menu.zip" >/dev/null 2>&1
    mkdir /tmp/menu
